  ...
  return (
    <div className='mt-12'>
      <div className='flex flex-wrap  justify-center '>
        <div className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded xl w-full lg:w-200 lg:h-full p-8 pt-9 m-3 bg-hero-pattern bg-no-rapeat bg-cover bg-center'>
          <div className='flex justify-between items-center'>
            <div>
              <p className='font-bold text-gray-400 '> Earnings</p>
              <p className='text-2xl'> $45,378,289</p>
        ...
        <div className='flex gap-10 flex-wrap justify-center'>
          <div className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-800'>
                  <div className='flex justify-between '>
                    <p className='font-semibold text-xl p-3'>
                      Revenue Updates
                    </p>
